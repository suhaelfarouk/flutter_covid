...
class BnewsPage extends StatefulWidget {
  @override
  _BnewsPageState createState() => _BnewsPageState();
}

class _BnewsPageState extends State<BnewsPage>
    with AutomaticKeepAliveClientMixin {
  List? newsData;
  fetchNewsData() async {
    http.Response response = await http.get(
      Uri.parse(
          'https://google-search3.p.rapidapi.com/api/v1/news/q=india+covid+news'),
      headers: {
