...
class AnewsPage extends StatefulWidget {
  @override
  _AnewsPageState createState() => _AnewsPageState();
}

class _AnewsPageState extends State<AnewsPage>
    with AutomaticKeepAliveClientMixin {
  List? newsData;
  fetchNewsData() async {
    http.Response response = await http.get(
      Uri.parse(
          'https://google-search3.p.rapidapi.com/api/v1/news/q=world+covid+news'),
      headers: {
